        ...
        >
          {TESTIMONIALS.map((t) => (
            ...
            >
              ...
              <p className="mt-4 text-sm font-medium text-[#f5f2eb]">{t.nom}</p>
              <p className="mt-1 text-[11px] text-[#8a8278]">{t.anciennete}</p>
              <p className="mt-3 text-sm leading-relaxed text-[#c8c0b4]">&ldquo;{t.texte}&rdquo;</p>
            </li>
          ))}
        </ul>
      </div>
